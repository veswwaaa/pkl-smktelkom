...
<body>
        ...
        <div class="navbar-right">
            <div class="dropdown">
                <button class="profile-dropdown" type="button" data-bs-toggle="dropdown">
                    <div class="profile-avatar">{{ strtoupper(substr($dudi->nama_dudi, 0, 1)) }}</div>
                    <i class="fas fa-chevron-down text-muted"></i>
                </button>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        <h6 class="dropdown-header">{{ $dudi->nama_dudi }}</h6>
                    </li>
                    <li>
    ...
    <div class="main-content">
        ...
        <div class="dash-header">
            <div>
                ...
                <p class="dash-header-sub">Selamat datang, <strong>{{ $dudi->nama_dudi }}</strong></p>
            </div>
        ...
        {{-- Alert: surat belum dilengkapi --}}
        @if ($suratPerluBalasan > 0)
            <div class="alert alert-warning d-flex align-items-center gap-3 border-0 shadow-sm mb-4" style="border-radius: 12px; background: #fffbea;">
                ...
                <div>
                    <strong>Perhatian:</strong> Terdapat {{ $suratPerluBalasan }} surat resmi dari sekolah yang belum dibalas. Silakan lengkapi di menu Surat Permohonan / Pengajuan.
                </div>
            </div>
        @endif
        ...
        <div class="stat-grid">
            <div class="stat-card siswa">
                ...
                <div>
                    ...
                    <div class="stat-number">{{ $totalSiswaMagang }}</div>
                </div>
            </div>
            ...
            <div class="stat-card pending">
                ...
                <div>
                    ...
                    <div class="stat-number">{{ $suratPerluBalasan }}</div>
                </div>
            </div>
        ...
        <div class="row g-4">
            ...
            {{-- Left Column: Chart & Active Interns List --}}
            <div class="col-lg-8">
                ...
                <div class="section-card">
                    <div class="section-head">
                        ...
                        <span class="badge bg-light text-dark fw-bold">{{ $totalSiswaMagang }} Siswa</span>
                    </div>
                    <div class="table-responsive">
                        @if ($totalSiswaMagang > 0)
                            <table class="table table-custom">
                                ...
                                <tbody>
                                    @foreach ($siswaMagang as $index => $siswa)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td>
                                            ...
                                            <td class="text-muted fs-7">
                                                @if ($siswa->tanggal_mulai_pkl && $siswa->tanggal_selesai_pkl)
                                                    {{ \Carbon\Carbon::parse($siswa->tanggal_mulai_pkl)->format('d M Y') }} - {{ \Carbon\Carbon::parse($siswa->tanggal_selesai_pkl)->format('d M Y') }}
                                                @else
                                                    -
                                                @endif
                                            </td>
            ...
            {{-- Right Column: Administrative Letters --}}
            <div class="col-lg-4">
                <div class="section-card">
                    <div class="section-head">
                        <div class="section-head-title">
    ...
    <script>
        ...
        const jurusanCounts = {!! json_encode($jurusanCounts) !!};
