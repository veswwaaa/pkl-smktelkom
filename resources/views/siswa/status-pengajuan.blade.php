                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p>{{ $pengajuan->tanggal_pengajuan ? \Carbon\Carbon::parse($pengajuan->tanggal_pengajuan)->format('d F Y H:i') : '-' }}</p>
                        </div>
                        <div class="col-md-6">
                    ...
                    @if($pengajuan->tanggal_response_pilihan_1)
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <p>{{ \Carbon\Carbon::parse($pengajuan->tanggal_response_pilihan_1)->format('d F Y H:i') }}</p>
                            </div>
                        </div>
                    @endif
                ...
                <div class="card-body">
                    ...
                    @if($pengajuan->tanggal_response_pilihan_2)
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <p><strong>Tanggal Response:</strong></p>
                                <p>{{ \Carbon\Carbon::parse($pengajuan->tanggal_response_pilihan_2)->format('d F Y H:i') }}</p>
                            </div>
                        </div>
                    @endif
                ...
                <div class="card-body">
                    ...
                    @if($pengajuan->tanggal_response_pilihan_3)
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <p><strong>Tanggal Response:</strong></p>
                                <p>{{ \Carbon\Carbon::parse($pengajuan->tanggal_response_pilihan_3)->format('d F Y H:i') }}</p>
                            </div>
                        </div>
                    @endif
