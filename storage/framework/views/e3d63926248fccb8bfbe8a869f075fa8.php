                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <p><?php echo e($dudiItem->nama_dudi); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item btn-upload-surat" href="#"
                                                    ...
                                                    data-dudi-nama="<?php echo e($dudiItem->nama_dudi); ?>"
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="#"
                                                    onclick="event.preventDefault(); editDudi(<?php echo e($dudiItem->id); ?>, '<?php echo e($dudiItem->nama_dudi); ?>', '<?php echo e($dudiItem->nomor_telpon); ?>', '<?php echo e($dudiItem->alamat); ?>', '<?php echo e($dudiItem->person_in_charge); ?>')">
                                            ...
                                            <li>
                                                <a class="dropdown-item text-danger" href="#"
                                                    onclick="event.preventDefault(); deleteDudi(<?php echo e($dudiItem->id); ?>, '<?php echo e($dudiItem->nama_dudi); ?>')">
...
<?php /**PATH C:\xampp\htdocs\pkl-smktelkom\resources\views/admin/kelola-dudi.blade.php ENDPATH**/ ?>