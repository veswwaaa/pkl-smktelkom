                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="action-btn btn-edit"
                                        onclick="editWaliKelas({{ $wk->id }}, '{{ $wk->nip }}', '{{ $wk->nama_admin }}', '{{ $wk->no_telpon }}', '{{ $wk->alamat }}', '{{ $wk->kelas }}')"
                                        data-bs-toggle="tooltip" title="Edit Data">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <button class="action-btn btn-reset"
                                        onclick="resetPasswordWaliKelas({{ $wk->id }}, '{{ $wk->nama_admin }}', '{{ $wk->nip }}')"
                                        data-bs-toggle="tooltip" title="Reset Password">
                                        <i class="fas fa-key"></i>
                                    </button>
                                    <button class="action-btn btn-delete"
                                        onclick="deleteWaliKelas({{ $wk->id }}, '{{ $wk->nama_admin }}')"
