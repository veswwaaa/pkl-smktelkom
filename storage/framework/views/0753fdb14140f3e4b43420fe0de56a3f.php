...
<body>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php if($surat->file_surat_pengajuan && $filePengajuanExists): ?>
                        <a href="/dudi/surat-pkl/<?php echo e($surat->id); ?>/download?type=surat-pengajuan"
                ...
                <div class="card-body">
                    <?php if($surat->file_balasan_pengajuan): ?>
                        ...
                        <div class="alert alert-success">
                            ...
                            <?php echo e($surat->tanggal_upload_balasan_pengajuan ? $surat->tanggal_upload_balasan_pengajuan->format('d M Y H:i') : '-'); ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <p><?php echo e($surat->catatan_balasan_pengajuan ?? 'Tidak ada catatan'); ?></p>
                            </div>
                        </div>

                        <?php if($surat->file_balasan_pengajuan && $fileBalasanPengajuanExists): ?>
                            <a href="/dudi/surat-pkl/<?php echo e($surat->id); ?>/download?type=balasan-pengajuan"
                                class="btn btn-secondary mb-3">
                                <i class="fas fa-file-pdf me-2"></i>Lihat Surat Balasan
                            </a>
                        <?php elseif($surat->file_balasan_pengajuan && !$fileBalasanPengajuanExists): ?>
    ...
    <script>
        ...
        document.getElementById('formBalasanPengajuan')?.addEventListener('submit', function(e) {
            ...
            // Validate file
            const fileInput = document.getElementById('file_balasan_pengajuan');
...
<?php /**PATH C:\xampp\htdocs\pkl-smktelkom\resources\views/dudi/surat-pengajuan.blade.php ENDPATH**/ ?>