...
<body>
    ...
    <div class="main-content">
        ...
        <div style="display: none;">
            <?php if(session('success')): ?>
                <div id="success-message" data-message="<?php echo e(session('success')); ?>"></div>
            <?php endif; ?>

            <?php if(session('error')): ?>
                <div id="error-message" data-message="<?php echo e(session('error')); ?>"></div>
            <?php endif; ?>

            <?php if($errors->any()): ?>
                <div id="validation-errors" data-errors="<?php echo e(json_encode($errors->all())); ?>"></div>
            <?php endif; ?>
        </div>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $siswaItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><span class="badge bg-info"><?php echo e($siswaItem->nis); ?></span></td>
                            <td><strong><?php echo e($siswaItem->nama); ?></strong></td>
                            <td><?php echo e($siswaItem->kelas); ?></td>
                            <td><?php echo e($siswaItem->jenis_kelamin); ?></td>
                            <td><?php echo e($siswaItem->angkatan); ?></td>
                            <td><span class="badge bg-success"><?php echo e($siswaItem->jurusan); ?></span></td>
                            <td>
                                <?php if($siswaItem->grade_kesiswaan == 'tidak_ada'): ?>
                                    <span class="badge bg-primary">Tidak Ada</span>
                                <?php elseif($siswaItem->grade_kesiswaan == 'ringan'): ?>
                                    <span class="badge bg-success">Ringan</span>
                                <?php elseif($siswaItem->grade_kesiswaan == 'sedang'): ?>
                                    <span class="badge bg-warning">Sedang</span>
                                <?php elseif($siswaItem->grade_kesiswaan == 'berat'): ?>
                            ...
                            <td>
                                <?php if($siswaItem->grade_kurikulum == 'A'): ?>
                                    <span class="badge bg-primary">A</span>
                                <?php elseif($siswaItem->grade_kurikulum == 'B'): ?>
                                    <span class="badge bg-success">B</span>
                                <?php elseif($siswaItem->grade_kurikulum == 'C'): ?>
                                    <span class="badge bg-warning">C</span>
                                <?php elseif($siswaItem->grade_kurikulum == 'D'): ?>
                                    <span class="badge" style="background-color: #ff9800;">D</span>
                                <?php elseif($siswaItem->grade_kurikulum == 'E'): ?>
                            ...
                            <td>
                                <?php if($siswaItem->status_penempatan == 'ditempatkan'): ?>
                                    <span class="badge bg-success">
                                        <i class="fas fa-check-circle"></i> Ditempatkan
                                    </span>
                                <?php elseif($siswaItem->status_penempatan == 'selesai'): ?>
                            ...
                            <td>
                                <?php if($siswaItem->dudi): ?>
                                    <small><?php echo e($siswaItem->dudi->nama_dudi); ?></small>
                                <?php else: ?>
                                    <span class="text-muted">-</span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <?php if($siswaItem->status_penempatan != 'belum'): ?>
                                            <li>
                                                <a class="dropdown-item" href="#"
                                                    onclick="event.preventDefault(); openSetTanggalModal(<?php echo e($siswaItem->id); ?>, '<?php echo e($siswaItem->nama); ?>', '<?php echo e($siswaItem->tanggal_mulai_pkl); ?>', '<?php echo e($siswaItem->tanggal_selesai_pkl); ?>')">
                                                    <i class="fas fa-calendar-alt text-primary"></i> Set Tanggal PKL
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="#"
                                                    onclick="event.preventDefault(); confirmCancelAssignment(<?php echo e($siswaItem->id); ?>, '<?php echo e($siswaItem->nama); ?>')">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#"
                                                onclick="event.preventDefault(); openGradeModal(<?php echo e($siswaItem->id); ?>, '<?php echo e($siswaItem->nama); ?>', '<?php echo e($siswaItem->nis); ?>', '<?php echo e($siswaItem->grade_kesiswaan); ?>', '<?php echo e($siswaItem->grade_kurikulum); ?>')">
                                        ...
                                        <li>
                                            <a class="dropdown-item text-danger" href="#"
                                                onclick="event.preventDefault(); confirmDelete(<?php echo e($siswaItem->id); ?>, '<?php echo e($siswaItem->nama); ?>', '<?php echo e($siswaItem->nis); ?>')">
    ...
    <script src="<?php echo e(asset('js/kelola-siswa.js')); ?>"></script>
    ...
    <!-- Hidden Delete Forms -->
    <?php $__currentLoopData = $siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $siswaItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <form id="delete-form-<?php echo e($siswaItem->id); ?>" action="/admin/siswa/<?php echo e($siswaItem->id); ?>" method="POST"
            style="display: none;">
            <?php echo csrf_field(); ?>
