...
<div class="row g-3 flex-nowrap">
        <div class="col">
            <div class="stat-card border-gray mb-3" onclick="window.location.href='/admin/siswa'" style="cursor:pointer;">
              <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <div class="stat-num">  {{ $dokumenList->where('status_cv_portofolio', 'sudah')->count() }}</div>
         ...
         <div class="col">
            <div class="stat-card border-gray mb-3" onclick="window.location.href='/admin/dudi'" style="cursor:pointer;">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="stat-num">{{ $dokumenList->where('status_surat_pernyataan', 'terkirim')->count() }}</div>
        ...
        <div class="col">
            <div class="stat-card border-gray mb-3" onclick="window.location.href='/admin/dudi'" style="cursor:pointer;">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                         <div class="stat-num">{{ $dokumenList->where('status_surat_tugas', 'terkirim')->count() }}</div>
    ...
    <!-- Modal Input Nomor Surat Tugas -->
    <div class="modal fade" id="modalInputNomorSurat" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="fas fa-file-signature me-2" style="color: #ee1c25;"></i>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="nomorSuratTugas" class="form-label">Nomor Surat <span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="nomorSuratTugas"
                            placeholder="Contoh: 001/ST/PKL-SMKTELKOM/XI/2025" required>
                        <div class="form-text">Format: [Nomor Urut]/ST/PKL-SMKTELKOM/[Bulan Romawi]/[Tahun]</div>
                    </div>
                    <input type="hidden" id="dokumenIdForSuratTugas">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="button" class="btn btn-success" onclick="submitKirimSuratTugas()">
...
@push('scripts')
    ...
    <script>
        ...
        function kirimSuratTugas(dokumenId) {
            // Simpan dokumen ID dan tampilkan modal input nomor surat
            document.getElementById('dokumenIdForSuratTugas').value = dokumenId;
            document.getElementById('nomorSuratTugas').value = '';
            new bootstrap.Modal(document.getElementById('modalInputNomorSurat')).show();
        }

        function submitKirimSuratTugas() {
            const dokumenId = document.getElementById('dokumenIdForSuratTugas').value;
            const nomorSurat = document.getElementById('nomorSuratTugas').value.trim();
            ...
            // Tutup modal input
            bootstrap.Modal.getInstance(document.getElementById('modalInputNomorSurat')).hide();

            // Konfirmasi pengiriman
            Swal.fire({
                title: 'Kirim Surat Tugas?',
                html: `Surat tugas dengan nomor <strong>${nomorSurat}</strong> akan dikirim ke siswa`,
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#28a745',
                cancelButtonColor: '#6c757d',
