    ...
    fetch("/admin/dudi", {
        ...
        .then(async (response) => {
            ...
            if (contentType && contentType.includes("application/json")) {
                ...
                throw new Error(
                    "Server tidak mengembalikan response JSON yang valid. Pastikan form data benar."
                );
            }
        })
        .then((data) => {
...
function showUploadSuratModal(idDudi, namaDudi) {
    ...
    document.getElementById("upload_id_dudi").value = idDudi; // Set again after reset
    ...
    fetch("/admin/dudi/upload-surat", {
        ...
        .catch((error) => {
            ...
            Swal.fire({
                ...
                title: "Gagal Upload!",
                text:
                    error.message || "Terjadi kesalahan saat mengupload surat",
                confirmButtonColor: "#e53e3e",
            });
        });
}
