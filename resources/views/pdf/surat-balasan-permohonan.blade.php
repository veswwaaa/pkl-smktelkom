...
<body>
    <!-- Kop Surat -->
    <div class="kop-surat">
        <h2>{{ strtoupper($dudi->nama_dudi) }}</h2>
        <p>{{ $dudi->alamat }}</p>
        <p>Telp: {{ $dudi->nomor_telpon ?? '-' }}</p>
    </div>
    ...
    <div class="nomor-surat">
        <table>
            <tr>
                ...
                <td>: {{ $surat->nomor_surat_permohonan ?? '-' }}/BALASAN/{{ date('Y') }}</td>
            </tr>
            <tr>
    ...
    <div class="data-penerimaan">
        ...
        @foreach ($dataPenerimaan as $jurusan => $data)
            <div class="jurusan-item">
                ...
                <div class="detail-item">
                    <strong>Kuota Penerimaan:</strong> {{ $data['kuota'] }} Siswa
                </div>
                <div class="detail-item">
    ...
    <div class="ttd">
        <div class="ttd-content">
            <p>{{ $dudi->alamat }}, {{ date('d F Y') }}</p>
            <p><strong>{{ $dudi->nama_dudi }}</strong></p>
            <div class="ttd-space"></div>
            <p><strong><u>{{ $dudi->person_in_charge ?? 'Pimpinan' }}</u></strong></p>
