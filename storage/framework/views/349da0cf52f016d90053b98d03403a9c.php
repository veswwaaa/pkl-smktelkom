                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $waliKelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $wk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <span class=><?php echo e($wk->kelas ?? '-'); ?></span>
                                </td>
                                <td>
                                    <code class="text-dark"><?php echo e($wk->no_telpon); ?></code>
                                </td>
                                <td>
                                    <span><?php echo e($wk->alamat); ?></span>
                                </td>
                                <td>
...
<?php /**PATH C:\xampp\htdocs\pkl-smktelkom\resources\views/admin/kelola-wali-kelas.blade.php ENDPATH**/ ?>